$(function () {
  ...
  function setup() {
    ...
    createPlatform(700, 400, 200, 20); // short but wide platform located 5p00 pixels from the left of the screen and 300 pixels from the top of the screen
    ...
    createPlatform(1030, 300, 200, 20); // short but wide platform located 500 pixels from the left of the screen and 300 pixels from the top of the screen 
    // TODO 2
    // Create collectables
    // You must decide on the collectable type, the x position, the y position, the gravity, and the bounce strength
    // Your collectable choices are 'database' 'diamond' 'grace' 'kennedi' 'max' and 'steve'; more can be added if you wish
    // example usage: createCollectable(type, x, y, gravity, bounce
    createCollectable("steve", 300, 200, 20,0.5); // creates a "steve" collectible at the coordinates (500, 300), falling with a high gravity of 20, and bouncing with 50% bounce
    ...
    createCollectable("kennedi",1050, 300); // creates a "kennedi" collectible at the coordinates (500, 300), falling with default gravity and bouncing with default bounce %
    // TODO 3
    // Create cannons
